...
corr_matrix = read_table('/Users/mgell/Work/pfactor/res/spin_cortical_cmat_within_only.txt', col_names = FALSE)
...
ggsave("/Users/mgell/Work/pfactor/plots/network_pub.pdf", p, width = 85, height = 70, units = "mm", device = cairo_pdf)  # vector, embeds fonts
ggsave("/Users/mgell/Work/pfactor/plots/network_pub.png", p, width = 4.5, height = 3, dpi = 600)
