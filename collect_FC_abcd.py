...
# Dataset info
#data = 'abcd/derivatives/freesurfer-5.3.0-HCP'
...
#subs_fc     = pd.read_csv('/data/project/impulsivity/pfactors/data/subs.txt',header=None)
#subs_retest = pd.read_csv('/data/project/impulsivity/pfactors/data/abcd_subs_w_retest.csv')
#subs = subs_fc[subs_fc[0].isin(subs_retest['available_subs'])]
#subs = subs.iloc[0:40,0]
#subs = subs.iloc[0:4700,0]
#subs = subs.iloc[4700:len(subs),0]
